...
before_save :default_values
 belongs_to :user
  ...
  validates_attachment :toefl , :content_type => { :content_type => ["image/jpeg", "image/gif", "image/png"] }, :size => { :in => 0..1000.kilobytes, :message => "Photo must be less than 1 megabytes in size"}
