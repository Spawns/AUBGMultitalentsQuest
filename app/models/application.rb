...
before_save :default_values
 belongs_to :user
  ...
  validates :high_school_grade, :gradebook_photo, :school, :school_municipality, :school_region, :school_town, :on => :update, :presence => true, :if => :active_or_educational?
  ...
  validates :favourite_subject, :self_describe, :learned_from, :photo, :presence => true, :on => :update,  :if => :active_or_letters?
